...
import type { ExternalBlob as _ExternalBlob, ProfilePhoto as _ProfilePhoto, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getProfilePhoto(): Promise<ProfilePhoto | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getProfilePhoto();
    ...
    async setProfilePhoto(arg0: ExternalBlob, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setProfilePhoto(await to_candid_ExternalBlob_n12(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ProfilePhoto_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProfilePhoto): Promise<ProfilePhoto> {
...
async function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProfilePhoto]): Promise<ProfilePhoto | null> {
    return value.length === 0 ? null : await from_candid_ProfilePhoto_n9(_uploadFile, _downloadFile, value[0]);
}
