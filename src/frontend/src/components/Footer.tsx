      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
          ...
          <a
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.color = "#7AFF6E";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLElement).style.color = "#8A9E88";
            }}
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: "#1E2E1C", textDecoration: "none" }}
              onMouseEnter={(e) => {
                (e.target as HTMLElement).style.color = "#7AFF6E";
              }}
              onMouseLeave={(e) => {
                (e.target as HTMLElement).style.color = "#1E2E1C";
              }}
            >
              caffeine.ai
            </a>
